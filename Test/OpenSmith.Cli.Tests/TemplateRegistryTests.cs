...
public class TemplateRegistryTests
{
    ...
    [Fact]
    public void ResolvesRealEntitiesTemplate()
    {
        // Integration test against real template files
        ...
        // Entities.cst registers 8 sub-templates
        Assert.True(registry.Entries.Count >= 8,
            $"Expected at least 8 templates, got {registry.Entries.Count}");
    }
}
