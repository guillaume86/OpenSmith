...
public class Type : Node
{
    ...
    public AssociationCollection Associations => associations;
    ...
    public TypeCollection SubTypes => subTypes;

    public override string ToString() =>
        KeyValue("Name", Name) + KeyValue("AccessModifier", AccessModifier) + KeyValue("Modifier", Modifier) +
