...
public static partial class Dbml
{
    private class DbmlDefaultValueNullifier : DbmlVisitor
    {
        ...
        public override Connection VisitConnection(Connection connection) => connection;
        ...
        public override Return VisitReturn(Return r) => r;
        ...
        public override TableFunctionReturn VisitTableFunctionReturn(TableFunctionReturn r) => r;
